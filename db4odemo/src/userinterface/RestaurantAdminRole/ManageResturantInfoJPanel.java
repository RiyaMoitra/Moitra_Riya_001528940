...
public class ManageResturantInfoJPanel extends javax.swing.JPanel {
    ...
    ManageResturantInfoJPanel(JPanel userProcessContainer, UserAccount account, EcoSystem business, RestaurantDirectory restaurantDirectory, MenuDirectory menuDirectory) {
