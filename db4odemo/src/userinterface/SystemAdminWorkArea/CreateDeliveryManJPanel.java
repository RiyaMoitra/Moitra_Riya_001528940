...
public class CreateDeliveryManJPanel extends javax.swing.JPanel {
    ...
    CreateDeliveryManJPanel(JPanel container, EcoSystem business, DeliveryManDirectory deliveryManDirectory) {
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        else if(!phoneFormat(phone))
        {
            ...
            Employee employee = business.getEmployeeDirectory().createEmployee(deliveryMan.getDeliveryId());

            UserAccount account = business.getUserAccountDirectory().createUserAccount(username, password, employee, new DeliverManRole());
