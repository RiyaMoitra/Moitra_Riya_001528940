    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if(validateUser && validatePassword) {
           if(radioCustomer.isSelected()) {
            Customer c = new Customer(txtPword.getText(), txtUser.getText());
            
            List<User> list = admin.custDir.getCustomerList();
            list.add(c);
            
            admin.custDir.setCustomerList(list);
        ...
        if(radioSupplier.isSelected()) {
            ...
            List<User> list = admin.suppDir.getSupplierList();
            
            list.add(s);
            admin.suppDir.setSupplierList(list);
        } 
        }
