...
public class LoginScreen extends javax.swing.JPanel {
    ...
    JPanel panelRight;
    String type;
    public LoginScreen(String type, JPanel panelRight, List<User> list) {
        initComponents();
        this.list = list;
        this.type = type;
        ...
        if(type.equals("Supplier")){
          if(user!= null){
            ...
            if(s.verify(txtPword.getText())) {
                ...
                JOptionPane.showMessageDialog(panelRight, "Invalid password");
    ...
    private void initialize(){
        ...
        String title = type + " Login Screen";
